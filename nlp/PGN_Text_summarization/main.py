...
from utils.config import train_x_seg_path, train_y_seg_path, test_x_seg_path, sample_total, batch_size, save_result_dir, \
    vocab_path, epochs, checkpoint_dir, checkpoint_prefix, vocab_size, val_x_seg_path, val_y_seg_path
...
def main():
    ...
    parser.add_argument("--mode", default='eval', help="run mode", type=str)
    ...
    parser.add_argument("--save_batch_train_data", default=False, help="save batch train input to pickle", type=bool)
    parser.add_argument("--load_batch_train_data", default=False, help="load batch train input from pickle",
                        type=bool)
